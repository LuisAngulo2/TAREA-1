...
FinFuncion
funcion multi=multiplicar_return
	//60. Función con return para multiplicar dos números.
	//ent:creamos  la Funcion de los numeros a multiplicar
...
funcion par_impar(n1)
	...
	FinSi
FinFuncion
Funcion area=areaRect(base,altura)
...
FinFuncion
funcion conv=convertirGrados(grados,Fahrenheit)
//	64. Función con return para convertir grados Celsius a Fahrenheit
	...
	conv=(grados*1.82)+32
	Escribir 'grados celsius a Fahrenheit:' conv
FinFuncion
...
Funcion imprimir1al10(i)
    ...
    Fin Para
FinFuncion
Funcion a=sumalista(numeroslista)
	...
	Para i=0 Hasta numeroslista(i)-1 Con Paso 1 Hacer
		...
		a=a+num
	Fin Para
	Escribir 'el resultado de la suma de los numeros de la lista es: ' a
FinFuncion
Algoritmo funcionesTarea1
    ...
    // Escribir 'ingrese altura'
     //leer altura
	//a=sumalista(numeroslista)
	//imprimir1al10
	//caracterFrase(frase1,caracter1)
	//conv=convertirGrados(grados,Fahrenheit)
	//nombre
	//area=areaRect(base,altura)
	//par_impar(n1)
	//multi=multiplicar_return
	//sumafuncion(n1,n2)
	saludar
FinAlgoritmo
